  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "image-set(url('/assets/optimized/content-experience-banner.webp') type('image/webp'), url('/images/content-experience-banner.jpg') type('image/jpeg'))",
        }}
        aria-hidden="true"
      />
