...
<html lang="en">
  <head>
    ...
    <meta property="og:site_name" content="Prestiege Luxor" />
  ...
  <body class="site-theme site-content-page">
    ...
    <header class="site-header scrolled" data-header>
      <a class="brand" href="/" aria-label="Prestiege Luxor home"><img class="brand-logo brand-logo-wide" src="/assets/prestiege-luxor-logo-light.png" alt="Prestiege Luxor" width="1684" height="315" /></a>
    ...
    <footer class="site-footer">
      <div class="footer-main"><a class="brand footer-brand" href="/" aria-label="Prestiege Luxor home"><span class="footer-logo-frame"><img class="brand-logo-wide" src="/assets/prestiege-luxor-logo-light.png" alt="Prestiege Luxor" width="1684" height="315" loading="lazy" /></span></a><p>Exotic and luxury car rentals with concierge delivery across Los Angeles and Orange County.</p><div class="footer-contact"><a href="tel:${phoneHref}">Call ${phoneLabel}</a><a href="sms:${phoneHref}">Text concierge</a><a href="mailto:reservations@kdsexotics.com">Email</a></div></div>
      ...
      <div class="footer-bottom"><span>© 2026 Prestiege Luxor. All rights reserved.</span><span>Rental approval required. Rates subject to availability.</span></div>
    </footer>
  ...
  const fleetCards = featuredCars.map((car) => `
          <article class="oc-showroom-card">
            <a class="oc-showroom-media" href="/cars/${car.slug}" aria-label="View ${car.make} ${car.model}">
              <img src="${getCarImage(car)}" alt="${car.make} ${car.model} available from Prestiege Luxor" width="1200" height="900" loading="eager" decoding="async" />
            </a>
      ...
      <section class="oc-location-hero" aria-labelledby="oc-location-title">
        ...
        <div class="oc-location-hero-content">
          ...
          <div class="oc-new-client-offer" aria-label="New client offer">
            ...
            <span>Your first Prestiege Luxor rental</span>
...
const locationPages = [
  {
    ...
    title: "Exotic Car Rental Los Angeles | Prestiege Luxor",
    description: "Rent an exotic or luxury car in Los Angeles with concierge delivery, flexible booking, and a curated fleet from Prestiege Luxor.",
    heading: "Exotic car rental in Los Angeles.",
    lead: "From a weekend in West Hollywood to a production day downtown, Prestiege Luxor coordinates the vehicle, timing, and delivery details around your plans.",
  ...
  },
  {
    ...
    title: "Exotic Car Rental Orange County | Prestiege Luxor",
    ...
    lead: "Prestiege Luxor serves Orange County clients looking for a memorable car, a straightforward quote, and delivery planned around the day—not the other way around.",
  ...
  },
  {
    ...
    title: "Luxury Car Rental Beverly Hills | Prestiege Luxor",
    description: "Reserve a luxury or exotic car in Beverly Hills with discreet concierge coordination and delivery from Prestiege Luxor.",
  ...
  },
  {
    ...
    title: "Exotic Car Rental Newport Beach | Prestiege Luxor",
    description: "Book an exotic car rental in Newport Beach for coastal drives, celebrations, hotels, and private events with Prestiege Luxor.",
  ...
  },
  {
    ...
    title: "LAX Exotic Car Delivery | Prestiege Luxor",
    description: "Plan exotic or luxury car delivery near LAX with flight-aware arrival coordination from Prestiege Luxor.",
  ...
  },
  {
    ...
    title: "SNA Exotic Car Delivery | Prestiege Luxor",
...
for (const page of locationPages) {
  ...
  const html = page.slug === "orange-county-exotic-car-rental"
    ...
    : pageShell({ ...pageOptions, eyebrow: "Prestiege Luxor Service Area", schemaType: "Service" });
...
if (existsSync(carDir)) {
  for (const file of readdirSync(carDir).filter((name) => name.endsWith(".html"))) {
    ...
    const title = html.match(/<title>(.*?)<\/title>/)?.[1] || "Exotic Car Rental | Prestiege Luxor";
    const description = html.match(/<meta name="description" content="([^"]*)"/i)?.[1] || "View this exotic rental car from Prestiege Luxor in Los Angeles and Orange County.";
