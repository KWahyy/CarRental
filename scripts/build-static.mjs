...
<html lang="en">
  ...
  <body class="site-theme site-content-page">
    ...
    <footer class="site-footer">
      <div class="footer-main"><a class="brand footer-brand" href="/" aria-label="Prestiege Luxor home"><span class="footer-logo-frame"><img class="brand-logo-wide" src="/assets/prestiege-luxor-logo-light.png" alt="Prestiege Luxor" width="1684" height="315" loading="lazy" /></span></a><p>Exotic and luxury car rentals with concierge delivery across Los Angeles and Orange County.</p><div class="footer-contact"><a href="tel:${phoneHref}">Call ${phoneLabel}</a><a href="sms:${phoneHref}">Text concierge</a><a href="mailto:Contact@prestigeluxor.com">Email</a></div></div>
